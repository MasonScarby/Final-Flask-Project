...
#         user_id = request.form.get("teacher_id")
#         test_name = request.form.get("test_name")
#         conn.execute(text("INSERT INTO tests (teacher_id, test_name) VALUES (:teacher_id, :test_name)"), flask.request.form)
#         conn.commit()
...
def get_test():
    ...
    test_info = conn.execute(text('SELECT * FROM tests WHERE test_id = :id'), id=test_id).fetchall()
